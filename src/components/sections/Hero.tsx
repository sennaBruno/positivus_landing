        ...
        <div className="w-full lg:w-1/2 relative flex justify-center">
          <div className="relative w-[450px] h-[450px] image-container">
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10">
              ...
              >
                <path
                  d="M350 120C350 120 250 180 150 180H80C70 180 60 190 60 200V300C60 310 70 320 80 320H150C250 320 350 380 350 380V120Z"
                  fill="#B9FF66"
                  stroke="black"
                  strokeWidth="3"
                />
                <path
                  d="M380 80C380 70 370 60 360 60C350 60 340 70 340 80V420C340 430 350 440 360 440C370 440 380 430 380 420V80Z"
                  fill="white"
                  stroke="black"
                  strokeWidth="3"
                />
                ...
                <path
                  d="M60 300C60 300 100 350 150 330M60 200C60 200 100 150 150 170"
                  stroke="black"
                  strokeWidth="2"
                  strokeDasharray="5 5"
                />
            ...
            <div className="absolute top-12 right-8 z-20">
              <div className="w-14 h-14 bg-black rounded-full flex items-center justify-center image-container">
                ...
                >
                  <path
                    d="M20.84 4.61C20.3292 4.099 19.7228 3.69364 19.0554 3.41708C18.3879 3.14052 17.6725 2.99817 16.95 2.99817C16.2275 2.99817 15.5121 3.14052 14.8446 3.41708C14.1772 3.69364 13.5708 4.099 13.06 4.61L12 5.67L10.94 4.61C9.9083 3.57831 8.50903 2.99871 7.05 2.99871C5.59096 2.99871 4.19169 3.57831 3.16 4.61C2.1283 5.64169 1.54871 7.04097 1.54871 8.5C1.54871 9.95903 2.1283 11.3583 3.16 12.39L4.22 13.45L12 21.23L19.78 13.45L20.84 12.39C21.351 11.8792 21.7563 11.2728 22.0329 10.6054C22.3095 9.93791 22.4518 9.22249 22.4518 8.5C22.4518 7.77751 22.3095 7.06209 22.0329 6.39464C21.7563 5.72718 21.351 5.12076 20.84 4.61Z"
                    fill="white"
                    stroke="white"
                    strokeWidth="2"
                    strokeLinecap="round"
